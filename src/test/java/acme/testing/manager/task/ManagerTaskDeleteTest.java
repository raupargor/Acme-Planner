...
public class ManagerTaskDeleteTest extends AcmePlannerTest {
	...
	@ParameterizedTest
	@CsvFileSource(resources = "/manager/deleteTask/positive.csv", encoding = "utf-8", numLinesToSkip = 1)
	@Order(10)
	...
	@ParameterizedTest
	@CsvFileSource(resources = "/manager/deleteTask/negative.csv", encoding = "utf-8", numLinesToSkip = 1)
	@Order(10)
